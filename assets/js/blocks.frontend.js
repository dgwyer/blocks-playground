...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__faqs_frontend__ = __webpack_require__(194);
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_FlexibleFaq__ = __webpack_require__(79);
...
var ffaq_els = document.querySelectorAll('.ffaq-container');
var element = wp.element.createElement(Welcome, { name: "Sara", title: "Mara" });
...
ffaq_els.forEach(function (ffaq_el, index) {
  ...
  render(wp.element.createElement(__WEBPACK_IMPORTED_MODULE_0__components_FlexibleFaq__["a" /* default */], { padding: JSON.parse(window[ffaq_id].faq_styles)[0].padding }), ffaq_el //document.querySelector('.ffaq-container')
  );
});
